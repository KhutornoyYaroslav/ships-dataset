...
img = cv2.imread(r"C:\Users\RMC\Desktop\ship_5.jpeg")
...
_, mask_mask = cv2.threshold(mask_mask, 140, 255, cv2.THRESH_BINARY)

cv2.imshow('image', mask_mask)
cv2.waitKey(0)
cv2.destroyAllWindows()


im2 = Image.fromarray(mask_mask)  # массив в изображение
